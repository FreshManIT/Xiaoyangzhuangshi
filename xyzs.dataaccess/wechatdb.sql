...
CREATE TABLE `syscontent`  (
  ...
  `ContentType` int(255) NULL DEFAULT NULL COMMENT '内容类型，关联文章类型',
...
-- ----------------------------
INSERT INTO `syscontent` VALUES (1, '2019-03-22 14:03:04', 1, '五一放假调整通知', '<p>&nbsp; &nbsp; &nbsp; &nbsp;五一放假调整通知专题为您提供最新最全的五一放假调整通知相关法律知识，以及提供全国各地的五一放假调整通知最快捷律师在线为您提供相关的法律咨询.<br/></p>', 0, '华律网', 1);
...
-- Records of sysdict
-- ----------------------------
INSERT INTO `sysdict` VALUES ('00a13dc801c94427ab0da6cbd7850399', '36', '一般农户补贴', 'SubsidySmallType', '3', 290, NULL, '1', '2018-11-07 16:20:54', '农业类', 0);
...
INSERT INTO `sysdict` VALUES ('190c99cd5d9e4c25830504de31323147', 'q1', '问题1：乡村振兴APP数据录入与乡村振兴网页版数据录入是同步更新的吗？', 'sys_cjwt', '是的，用户可通过APP或者网页端进行数据录入，数据实时同步更新。', 0, NULL, '1', '2018-10-22 11:03:43', NULL, 0);
...
INSERT INTO `sysdict` VALUES ('5da5deaa24f64a459a68623361e4e6f9', '35', '独生子女奖金名称过程啊导致的较好的较好的手机号建华大街说的就', 'SubsidySmallType', '6', 350, NULL, '1', '2018-09-19 11:34:09', '卫生计生类', 0);
...
INSERT INTO `sysusermenu` VALUES (15, 1, 1, 0);
INSERT INTO `sysusermenu` VALUES (16, 1, 2, 0);
INSERT INTO `sysusermenu` VALUES (17, 1, 3, 0);
INSERT INTO `sysusermenu` VALUES (18, 1, 5, 0);
INSERT INTO `sysusermenu` VALUES (19, 1, 6, 0);
INSERT INTO `sysusermenu` VALUES (20, 1, 7, 0);
INSERT INTO `sysusermenu` VALUES (21, 1, 8, 0);
